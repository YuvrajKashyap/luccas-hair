...
// Visibility lives entirely in CSS, driven by the data-scroll / data-past-hero
// attributes MobileFx maintains on <html>: the dock stays out of the way until
// the hero CTA scrolls past, ducks while scrolling down, returns on scroll-up.
